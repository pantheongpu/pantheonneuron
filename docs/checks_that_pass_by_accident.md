...
would go. This repo has now produced twelve of them, and they are collected
...
### 12. The check passes because the collection is empty
...
twelve above were found by reading what a passing check had filtered out.
